...
class TrainingPipeline:
    ...
    def start_data_transformation(self,feature_store_file_path):
        try:
            data_transformation = DataTrasformation(feature_store_file_path=feature_store_file_path)
    ...
    def run_pipeline(self):
        try:
            ...
            accu_score = self.start_model_training(train_arr, test_arr)
            print("training completed. Trained model score:", accu_score)
        except Exception as e:
            raise CustomException(e,sys)
